...
class ConfigLoaderTest {
    ...
    @Test
    fun `private_base_url が省略された場合は null が入ること`(@TempDir tempDir: Path) {
        // Arrange
        val yamlContent = """
            app:
              interval: "5min"
        ...
        // As long as API_PUBLIC_BASE_URL isn't explicitly set in the test environment,
        // it should retain the values from YAML (or default if null).
