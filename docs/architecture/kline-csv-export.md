...
CSVの1行は1本のK線を表します。
例えば `KLINE_EXPORT_INTERVAL=5min` の場合、1行は5分間の価格情報を表します。
...
KLINE_EXPORT_START_DATE から KLINE_EXPORT_END_DATE までを、1日ずつ取得します。
開始日と終了日は、どちらも取得対象に含めます。
...
この場合、APIを呼び出す日付は以下の3日分です。

- 20260501
- 20260502
- 20260503

終了日の 20260503 も取得対象に含めます。
