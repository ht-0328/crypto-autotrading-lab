...
## 概要
本ドキュメントは、本プロジェクトにおける開発環境のセットアップ手順を解説しています。新しくプロジェクトに参加したメンバーが、ローカルでコードをビルド・実行できるようにするためのガイドです。

## 対象読者
開発メンバー

## この文書で分かること
- VS Code Dev Containersの利用前提
- GitHub CLIを用いた変数（Variables）の管理方法
- アプリケーションのテスト・実行手順
- サポートされている実行形態
