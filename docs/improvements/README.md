...
| 状態 | ファイル | 内容 | 重要度 |
| --- | --- | --- | --- |
| 実施済み（未コミット） | [pr01-docker-clean-scope.md](pr01-docker-clean-scope.md) | ホストの Docker を全消しするスクリプトを安全にする | 高 |
| 未着手 | [pr03-private-api-log-leak.md](pr03-private-api-log-leak.md) | Private API レスポンスのログ流出を止める | 高 |
| 未着手 | [pr02-cloud-run-config.md](pr02-cloud-run-config.md) | Cloud Run で設定が効かない・ログが残らない問題を直す | 高 |
| 未着手 | [pr04-state-repository-crash-safe.md](pr04-state-repository-crash-safe.md) | 状態保存をクラッシュセーフにする | 高 |
