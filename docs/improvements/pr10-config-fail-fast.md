...
| 読んだあとできること | 設定の読み込み失敗を起動時に落ちるようにできる |
...
[findings.md](findings.md) の **T** / **B** / **D** / **Z** / **C** / **AD** / **AE**
...
- **C（中、乖離解消のみ）**: gcloud と Terraform で、渡す環境変数が食い違っています。
  一本化は [backlog.md](backlog.md) 送りです。食い違いだけ消します。
